...
public interface IAuctionService {
    AuctionDetailResponseDTO createAuction(String sellerId, String name, String description, ItemType type, ItemAttributesDTO attributes, double startPrice, long startTime, long endTime);
