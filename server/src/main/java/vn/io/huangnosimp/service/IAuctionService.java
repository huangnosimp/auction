...
public interface IAuctionService {
    AuctionResponseDTO createAuction(String sellerId, String name, String description, ItemType type, ItemAttributesDTO attributes, double startPrice, long startTime, long endTime, ItemCondition condition);
